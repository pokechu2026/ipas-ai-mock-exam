...
function getDraftSecret() {
	return "26130e78-bedc-4d87-bcf3-4533fe48b3c3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "743dc296-b093-452c-98a9-b25f8df7e176";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "743dc296-b093-452c-98a9-b25f8df7e176") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "743dc296-b093-452c-98a9-b25f8df7e176",
		rootBoundaryId
	});
}
/**
